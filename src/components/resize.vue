    ...
    <div class="containers">
      <div class="">
        <div class="upload-image">
          <label class="file-upload-logo" for="fileOpload">
        ...
        <div class="form-container">
          <div class="form-check">
            <input
              ...
              id="ShowDimension"
            />
            <label class="form-check-label" for="ShowDimension"
          ...
          <div class="form-check">
            <input
              type="checkbox"
              class="form-check-input"
              onclick="showWidthHeight()"
              id="ShowWidthandHeight"
            />
            <label class="form-check-label" for="ShowWidthandHeight"
              >Customize Height And Width</label
            >
          </div>
          <input
            type="number"
            placeholder="Resize in Percentage"
            id="percent"
          ...
          <input
            ...
            id="dimension"
            style="display: none"
            placeholder="Enter only Width and the see the Magic"
            class="form-control mb-2"
          />
          <input
            type="number"
